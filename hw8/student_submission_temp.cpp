...
int main(int argc, char** argv) {
    ...
    //if (rank == 0) {
        ...
        if (rank == 0) {
        std::cout << problemData->readGrid[1][1] << std::endl;
        std::cout << *problemData->readGrid[1][1] << std::endl;
        std::cout << &(problemData->readGrid[1][1]) << std::endl;
        //std::cout << problemData->readGrid << std::endl;
        // std::cout << &(*problemData->readGrid[0][1503]) << std::endl;
        // std::cout << &(*problemData->readGrid[1][0]) << std::endl;
        // std::cout << &(*problemData->readGrid[1][1]) << std::endl;
        // std::cout << &(*problemData->readGrid[1][1503]) << std::endl;
        }
        //MPI_Bcast(*problemData->readGrid, (GRID_SIZE) * (GRID_SIZE), MPI_FLOAT, 0, MPI_COMM_WORLD);
    //}
    ...
    std::cout << proc_rows << "   " <<size << std::endl;
    //std::cout << "DONE1" << std::endl;
    //std::cout << problemData->readGrid[1024] << std::endl;
    ...
    for (int iteration = 0; iteration < NUM_SIMULATION_STEPS; ++iteration) {
        ...
        if (rank == 0)
        {
            ...
            MPI_Send(&(problemData->readGrid[end_row - 1][0]), GRID_SIZE, MPI_C_BOOL, 1, 0, MPI_COMM_WORLD);
            //std::cout << "DONE2" << std::endl;
